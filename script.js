...
document.getElementById("hold").addEventListener("click", function () {
  if (Number(points[currentPlayer].innerHTML) >= 10) {
    ...
    // FIX
    // sta controllando valore prima di arrivare a 10 e quindi vincitore in ritardo
    console.log("player points", points[0].nodeName, points[0].innerHTML);
    if (currentPlayer === 0) {
      currentPlayer = 1;
      player[0].classList.remove("active-player");
      player[1].classList.add("active-player");
